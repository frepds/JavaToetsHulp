package ToetsHulp.NieuwePoging.Oktober31_2022;
...
//		Opgave1.Vlag v = new Opgave1.Vlag(77, "blauw", "geel");
//		v.printVlag();         //>>   77 + blauw + geel
//		System.out.println(v); //>>   77 + blauw + geel
//
//		 // v.grootte = -98765;  // niet meer mogelijk!
//		v = new Opgave1.Vlag(-98765, "blauw", "geel");  // te klein: wordt 50
//		v.printVlag();         //>>   50 + blauw + geel
//
//		v = new Opgave1.Vlag(1234567, "blauw", "geel");  // te groot: wordt 500
//		v.printVlag();         //>>   500 + blauw + geel
//
//		v = new Opgave1.Vlag(444, "blauw", "geel");  // binnen bereik. grootte wordt 444.
...
//		Opgave1.Vlag v_kleuren = new Opgave1.Vlag(300, "blauw", "blauw");
...
//		Opgave1.Vlag v_input = new Opgave1.Vlag(77, "donkerwit", input);
//
//		v_input.printVlag();      //>>   77 + donkerwit + donkerwit
//		v_input.printKleuren();   //>>   donkerwit
//
//		 // vb #3: tweede kleur is null.
//		Opgave1.Vlag v_1kleur = new Opgave1.Vlag(450, "zwart", null);
...
//======================== code om Opgave1.VlaggenWinkel (opgave 1) te testen ========================


	//---------------------- code om opgave 1(c) te testen --------------------
	//
//	public static void main(String[] args) {
//		Opgave1.VlaggenWinkel s = new Opgave1.VlaggenWinkel();
//		Opgave1.Vlag mijn_vlag = s.maakVlag(60, "blauw", "geel");
//		System.out.println(mijn_vlag);        //>>   60 + blauw + geel
//
//		 // een vriend wil net zo'n vlag als ik heb, maar wat groter!
//		Opgave1.Vlag vlag_voor_vriend = s.zelfdeAls(mijn_vlag, 444);
...
//======================== code om Opgave2.Oplader (opgave 2) te testen ========================


	//---------------------- code om opgave 2 te testen --------------------
	//
//	public static void main(String[] args) {
//		Opgave2.Land nl = new Opgave2.Land("NL", 31);
//		Opgave2.Land nl_zelfde = new Opgave2.Land("Nederland", 31);
//		Opgave2.Land usa = new Opgave2.Land("U.S.A.", 1);
...
//		Opgave2.Oplader _5kwNL = new Opgave2.Oplader(5, true, nl);
//
//		 // ander object, zelfde gegevens:
//		System.out.println(_5kwNL.equals(new Opgave2.Oplader(5, true, nl)));  //>>   true
//
//		 // zelfde vermogen (5000 watt en 4992 watt) en zelfde land
//		Opgave2.Oplader _5kw_ook_nl = new Opgave2.Oplader(4992, false, nl_zelfde);
//		System.out.println(_5kwNL.equals(_5kw_ook_nl));               //>>   true
//
//		 // 5 kiloWatt is niet gelijk aan 4111 watt (te groot verschil):
//		Opgave2.Oplader _4111watt_nl = new Opgave2.Oplader(4111, false, nl);
//		System.out.println(_5kwNL.equals(_4111watt_nl));              //>>   false
//
//		 // 5 kiloWatt is niet gelijk aan 5 watt:
//		Opgave2.Oplader _5watt_nl = new Opgave2.Oplader(5, false, nl);
//		System.out.println(_5kwNL.equals(_5watt_nl));                 //>>   false
//
//		 // ander land
//		System.out.println(_5kwNL.equals(new Opgave2.Oplader(5, true, usa))); //>>   false
//	}
