package ToetsHulp.Theorie.Juni8.Antwoorden.Opgave1;
...
public class Route
{
	...
	public String toString() {
		if( this.afstand < grens ) {
			return "ToetsHulp.Theorie.Juni8.Antwoorden.Opgave1.Route: te kort";
		}
		return "ToetsHulp.Theorie.Juni8.Antwoorden.Opgave1.Route van " + this.afstand + " km, start: " + this.start;
	}
	...
	public static void main( String[] args ) { demo_static(); }
