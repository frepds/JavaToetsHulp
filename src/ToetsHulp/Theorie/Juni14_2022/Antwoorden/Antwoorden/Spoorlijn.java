...
//	}
	...
	public boolean equals(Object o) { //aanpassing van de auto-gegenereerde equals.
		...
		if (this_eerste.equals(that_eerste) && this_laatste.equals(that_laatste)) { return true; }

		// begin van ene is einde van ander, en andersom.
		if (this_eerste.equals(that_laatste) && this_laatste.equals(that_eerste)) { return true; }
	...
	public static void printLangste() { System.out.println(langste); }
