...
public class Catwoman extends Held
{
	...
	public Catwoman() { super("Captain Napalm", 42); }
	...
	public String specialeKracht() { return "Catwoman --> specialeKracht"; }

    // moet geimplementeerd worden (overriding), vanwege de inhoud van wat gereturnd moet worden.
	public String vermomming() { return "Catwoman --> vermomming"; }

    // moet geimplementeerd worden (overriding), vanwege de inhoud van wat gereturnd moet worden.
	public int vermomming(int x) { return 42; }
	...
	public int snelheid(int y, int z) { return 42; }
}
